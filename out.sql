...
CREATE TABLE public.aluminum_etch (
    id integer NOT NULL,
...
CREATE TABLE public.aluminum_evaporation (
    id integer NOT NULL,
    chip_number integer NOT NULL,
    chip_owner character varying(64),
    creation_date date,
...
CREATE TABLE public.deposition_template (
    id integer NOT NULL,
    chip_number integer NOT NULL,
    chip_owner character varying(64),
    creation_date date,
...
CREATE TABLE public.deposition_700b (
)
INHERITS (public.deposition_template);
...
CREATE TABLE public.deposition_p504 (
)
INHERITS (public.deposition_template);
...
CREATE TABLE public.oxide_etch (
    id integer NOT NULL,
    chip_number integer NOT NULL,
    chip_owner character varying(64),
    creation_date date,
...
CREATE TABLE public.patterning (
    id integer NOT NULL,
    chip_number integer NOT NULL,
    chip_owner character varying(64),
    creation_date date,
...
CREATE TABLE public.plasma_clean (
    id integer NOT NULL,
    chip_number integer NOT NULL,
    chip_owner character varying(64),
    creation_date date,
...
CREATE TABLE public.plasma_etch (
    id integer NOT NULL,
    chip_number integer NOT NULL,
    chip_owner character varying(64),
    creation_date date,
...
COPY public.aluminum_etch (id, chip_number, chip_owner, creation_date, alum_etch_temp, alum_etch_time, stir_rpm, metric_alum_etch_depth, metric_photoresist_peeling, metric_aluminum_peeling, metrology_link, notes) FROM stdin;
\.
...
COPY public.aluminum_evaporation (id, chip_number, chip_owner, creation_date, aluminum_evaporation_temp, aluminum_evaporation_time, pressure_before_start_seq, pressure_before_evaporation, metric_layer_thickness, metric_layer_thick_qcm, metric_deposition_rate, metrology_link, notes) FROM stdin;
\.
...
COPY public.chip_list (chip_number, chip_owner, creation_date, notes) FROM stdin;
\.
...
COPY public.deposition_700b (id, chip_number, chip_owner, creation_date, cleaning_step, days_p504_at_room_temp, prebake_temp, prebake_time, amount_drops, spin_rpm, spin_time, bake_temp, bake_time, humidity, metric_layer_thickness, metric_cracking, metric_particles, metrology_link, notes) FROM stdin;
\.
...
COPY public.deposition_p504 (id, chip_number, chip_owner, creation_date, cleaning_step, days_p504_at_room_temp, prebake_temp, prebake_time, amount_drops, spin_rpm, spin_time, bake_temp, bake_time, humidity, metric_layer_thickness, metric_cracking, metric_particles, metrology_link, notes) FROM stdin;
\.
...
COPY public.deposition_template (id, chip_number, chip_owner, creation_date, cleaning_step, days_p504_at_room_temp, prebake_temp, prebake_time, amount_drops, spin_rpm, spin_time, bake_temp, bake_time, humidity, metric_layer_thickness, metric_cracking, metric_particles, metrology_link, notes) FROM stdin;
\.
...
COPY public.oxide_etch (id, chip_number, chip_owner, creation_date, max_temp_glass_reached, oxide_etch_time, oxide_etch_temp, metric_oxide_etch_depth, metrology_notes, notes) FROM stdin;
\.
...
COPY public.plasma_clean (id, chip_number, chip_owner, creation_date, o2_flow, rf_power, clean_time, metric_contaminants, metrology_notes, notes) FROM stdin;
\.
...
COPY public.plasma_etch (id, chip_number, chip_owner, creation_date, o2_flow, sf6_flow, rf_power, etch_time, etch_depth, notes) FROM stdin;
\.
...
ALTER TABLE ONLY public.aluminum_etch
...
ALTER TABLE ONLY public.aluminum_evaporation
...
ALTER TABLE ONLY public.chip_list
...
ALTER TABLE ONLY public.deposition_700b
...
ALTER TABLE ONLY public.deposition_p504
...
ALTER TABLE ONLY public.oxide_etch
...
ALTER TABLE ONLY public.deposition_template
...
ALTER TABLE ONLY public.patterning
...
ALTER TABLE ONLY public.plasma_clean
...
ALTER TABLE ONLY public.plasma_etch
